...
#List of zipcodes (Seattle) that we want census tracts for
...
seattleData <- seattleData %>%
  select(-TRACT.y, -OTH_RATIO.x, -OTH_RATIO.y, -RES_RATIO.x, -RES_RATIO.y, -TOT_RATIO.x, -TOT_RATIO.y, -BUS_RATIO.x, -BUS_RATIO.y)
...
seattleTreeCanopy <- st_as_sf(seattleTreeCanopy, coords = )
