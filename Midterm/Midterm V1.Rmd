...
seattleData <- seattleData %>%
  select(price,bedrooms, bathrooms, condition, sqft_basement, lat, long, yr_built, yr_renovated, zipcode, floors)

#summary statistics should ideally combine the different datasets 
#want the summary stats to cover internal (basement,price, ), schools, sidewalks, and tree canopy)
summary(seattleData)
