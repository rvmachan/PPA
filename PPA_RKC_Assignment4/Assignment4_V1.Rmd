...
```{r create_partition}
set.seed(3456)
trainIndex <- createDataPartition(advertising$click, p = .50, #splitting into 50-50 in training and testing models
                                  list = FALSE,
                                  times = 1)
...
advertisingModel <- glm(clickNumeric ~ ., #glm is generalized linear model, taking in the defaults
